    ...
    attach: function (context, settings) {
      $(context).find('.slideshow-fullwidth .rev_slider').once('mtSliderRevolutionFullWidthInit').each(function() {
        ...
        var settings = {
          sliderType: "standard",
          sliderLayout: "auto",
          gridheight: parseInt(drupalSettings.catalogplus.sliderRevolutionFullWidthInit.slideshowFullWidthInitialHeight),
          delay: drupalSettings.catalogplus.sliderRevolutionFullWidthInit.slideshowFullWidthEffectTime,
          ...
          navigation: {
            ...
            bullets:{
              ...
              direction: "horizontal",
              space: 5,
              h_align: drupalSettings.catalogplus.sliderRevolutionFullWidthInit.slideshowFullWidthBulletsPosition,
              v_align: "bottom",
              h_offset: 0,
              v_offset: 20,
              tmp: "",
            ...
            touch:{
              touchenabled: drupalSettings.catalogplus.sliderRevolutionFullWidthInit.slideshowFullWidthTouchSwipe,
              swipe_treshold: 75,
              swipe_min_touches: 1,
        ...
        if ( drupalSettings.catalogplus.sliderRevolutionFullWidthInit.slideshowFullWidthAutoHeight ) {
          autoHeightSettings = {
            autoHeight: 'on',
          }
